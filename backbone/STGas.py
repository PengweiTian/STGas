...
class RepViTGas_Block(nn.Module):
    def __init__(self, input_channel, output_channel, kernel_size=3, stride=2, use_se=True, use_ge=True, use_hs=True):
        ...
        if stride == 2:
            ...
            self.GAM = GAM(input_channel, input_channel) if use_ge else nn.Identity()
