...
def multiclass_nms(
    ...
    Returns:
        tuple: (bboxes, labels), tensors of shape (k, 5) and (k, 1). Labels \
            are 0-based.
    """
    # multi_scores 2100*num_class
    num_classes = multi_scores.size(1) - 1 # 去除背景类别
    ...
    # bboxes 2100*num_class*4
    # scores 2100*num_class
    scores = multi_scores[:, :-1]  # 得到所有类别分数

    # filter out boxes with low scores
    valid_mask = scores > score_thr  # 2100*num_class
