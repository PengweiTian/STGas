...
from STGas.util import bbox2distance, distance2bbox, multi_apply, overlay_bbox_cv
...
class NanoDetPlusHead(nn.Module):
    ...
    def loss(self, preds, gt_meta, aux_preds=None):
        ...
        ] # 16,32,64,128==>16*16,8*8,4*4,2*2===>256+64+16+4=340
        ...
        if aux_preds is not None:
            ...
            # print(cls_preds.shape) # (B*T,1360,1)
            # print(center_priors.shape) # (B*T,1360,4)
            # print(decoded_bboxes.shape) # (B*T,1360,4)
            # print(gt_bboxes.shape) # (B*T,1,4)
            # print(gt_labels.shape) # (B*T,1)
    ...
    def target_assign_single_img(
        ...
        num_priors = center_priors.size(0) # 1360
